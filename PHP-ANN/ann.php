<?php
// Step 1: Import necessary libraries for Python interaction
// I wrote this code to enable communication between PHP and Python using the shell_exec function
// shell_exec allows us to execute shell commands from PHP
?>
...
data = pd.read_csv('/path/to/Cyberattacks Detection.csv')
